...
// The term/reading guessing heuristic lives in the engine (`anki::field_guessing`)
// so the Tauri backend shares it (T040); re-exported to keep old paths resolving.
pub use crate::anki::guess_field_mappings;
