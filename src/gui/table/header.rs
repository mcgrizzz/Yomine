    ...
    ui.horizontal(|ui| {
        ...
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            ui.vertical(|ui| {
                ...
                if !app.sentences.is_empty() && !app.anki_filtered_terms.is_empty() {
                    ui.horizontal(|ui| {
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            let comp_pct = app.file_comprehension * 100.0;
                            ...
                            ui.label(
                                RichText::new(format!("Estimated comprehension: {:.1}%", comp_pct))
                                    .color(color)
                                    .size(13.0)
                                    .strong(),
                            )
