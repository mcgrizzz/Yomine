...
Supports `.srt`, `.ass`, `.ssa`, `.txt`, and `.epub` files. A premade frequency dictionary generated from the [AniList Top 500](https://github.com/user-attachments/files/31227863/Anilist.Top.500.zip) is also available.
